            ...
            <div className="app-modal-panel w-full max-w-lg overflow-hidden flex flex-col max-h-[90vh]">
                <div className="app-modal-header flex justify-between items-center p-3.5 sm:p-4">
                    <div className="flex items-center gap-2">
                        <div className="w-9 h-9 rounded-[var(--radius-control)] bg-purple-100 dark:bg-purple-900/30 text-purple-600 flex items-center justify-center">
                            <StarsIcon className="text-lg" />
                        </div>
                        <div>
                            <h2 className="text-base sm:text-lg font-bold text-[var(--text-primary)]">AI Generator Soal</h2>
                ...
                <div className="p-3.5 sm:p-4 overflow-y-auto space-y-3.5">
                    ...
                    {provider === 'gemini' && !hasGeminiKey && (
                        <div className="bg-yellow-50 dark:bg-yellow-900/20 p-3 rounded-[var(--radius-control)] border border-yellow-200 dark:border-yellow-800 flex items-start gap-2">
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            className="w-full p-2.5 border border-[var(--border-secondary)] rounded-[var(--radius-control)] bg-[var(--bg-secondary)] focus:ring-2 focus:ring-[var(--border-focus)] outline-none min-h-[92px]"
                        />
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input 
                                ...
                                className="w-full p-2.5 border border-[var(--border-secondary)] rounded-[var(--radius-control)] bg-[var(--bg-secondary)]"
                            />
                        </div>
                         <div>
                            <label className="block text-sm font-medium text-[var(--text-secondary)] mb-1">Kesulitan</label>
                            <select value={difficulty} onChange={(e) => setDifficulty(e.target.value)} className="w-full p-2.5 border border-[var(--border-secondary)] rounded-[var(--radius-control)] bg-[var(--bg-secondary)]">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select value={qType} onChange={(e) => setQType(e.target.value as QuestionType)} className="w-full p-2.5 border border-[var(--border-secondary)] rounded-[var(--radius-control)] bg-[var(--bg-secondary)]">
